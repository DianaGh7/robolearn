...
- [ ] Step 1: Edit lib/screens/challenge_screen.dart per plan
  ...
  - Update SizedBox(width: 6) → SizedBox(width: 3) between streak & status badge
- [ ] Step 2: Test flutter run on challenge_screen
- [ ] Step 3: Mark complete & attempt_completion
